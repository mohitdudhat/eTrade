          ...
          <div className="col-lg-6">
            ...
            >
              <span className="title-highlighter highlighter-secondary">
                <i className="fal fa-exclamation-circle"></i> Oops! Something's
                missing.
              </span>
              <h1 className="title">Page not found</h1>
              <p>
                It seems like we don't find what you searched. The page you were
                looking for doesn't exist, isn't available, or is loading
                incorrectly.
              </p>
              <a
                href="index.html"
